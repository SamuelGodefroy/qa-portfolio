...
| 3 | Enter an email without "@" into the "Email" field | The entered data is displayed in the text field | - |
...
| 5 | Click on the "Registration" icon/button | Registration error. The email is missing the "@" symbol | - |
