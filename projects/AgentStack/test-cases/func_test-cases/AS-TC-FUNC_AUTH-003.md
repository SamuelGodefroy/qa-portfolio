...
| 3 | Leave the "Email" field empty | The "Email" field is empty | - |
| 4 | Enter a valid password into the "Password" field | The "Password" field displays "dots" hiding the entered password | - |
| 5 | Click on the "Registration" icon/button | Registration error. The email field cannot be empty | - |
